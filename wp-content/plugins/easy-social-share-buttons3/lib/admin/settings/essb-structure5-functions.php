...
ESSBOptionsStructureHelper::field_switch_panel('functions', 'functions', 'deactivate_method_sharebutton', __('Turn off Share Button', 'essb'), __('', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
...
ESSBOptionsStructureHelper::field_textbox_stretched('functions', 'functions', 'deactivate_on_share', __('Social Share Buttons', 'essb'), __('Deactivate function on posts/pages with these IDs? Comma separated: "11, 15, 125". Deactivating plugin will make no style or scripts to be executed for those pages/posts related to this function', 'essb'));
ESSBOptionsStructureHelper::field_textbox_stretched('functions', 'functions', 'deactivate_on_share_cats', __('Social Share Buttons on Posts from Categories', 'essb'), __('Deactivate function on selected categories. Comma separated category IDs: 11, 15, 125', 'essb'));
...
ESSBOptionsStructureHelper::tab_start('functions', 'functions', 'buttons-tabs-4', 'false');
ESSBOptionsStructureHelper::field_heading ('functions', 'functions', 'heading5', __('Manage Active & Working Social Networks', 'essb'));
ESSBOptionsStructureHelper::hint('functions', 'functions', '', __('The manage of active networks gives you a chance to let in menu just the networks you will really use. In case you need to add more networks you can do this here or remove all the selected and retore back the default state.', 'essb'), '', 'glow');
ESSBOptionsStructureHelper::field_switch('functions', 'functions', 'activate_networks_manage', __('Make plugin use only selected networks', 'essb'), __('Use this feature in case you does not need all networks of plugin. That makes easy to manage and easy to personalize. Also that can save resources on a share counter update because it will refer to active networks only', 'essb'), '', __('Yes', 'essb'), __('No', 'essb'));
ESSBOptionsStructureHelper::field_network_select('functions', 'functions', 'functions_networks', 'functions', true);
ESSBOptionsStructureHelper::tab_end('functions', 'functions');
