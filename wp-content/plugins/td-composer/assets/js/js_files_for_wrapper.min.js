...
tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{tdc_savings:window.tdcAdminSettings.tdcSavings,action:"tdc_ajax_save_parts"}}).done(function(b,e,a){"success"===e&&(_.isObject(b)&&_.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):("undefined"!==typeof d&&d.call(g),tdcSidebar.updateSavedShortcodes()))}).fail(function(b,e,a){})},b64EncodeUnicode:function(g){return btoa(encodeURIComponent(g).replace(/%([0-9A-F]{2})/g,
function(d,b){return String.fromCharCode("0x"+b)}))},b64DecodeUnicode:function(g){return decodeURIComponent(atob(g).split("").map(function(d){return"%"+("00"+d.charCodeAt(0).toString(16)).slice(-2)}).join(""))}}})();var tdcRecycle;
...
tdcElementUI.bindEmptyElement(c);w.append(c)}tdcRecycle.takeSnapshot("Delete element");tdcOperationUI.setDraggedElement(a);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({wasSidebarElementDragged:d,wasElementDragged:k,wasInnerColumnDragged:h,wasInnerRowDragged:m,wasTempInnerRowDragged:n,wasColumnDragged:p,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:A,sourceColParam:f});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);
...
!0,!1);return}var p=tdcIFrameData.tdcRows;tdcIFrameData.tdcRows=new tdcIFrameData.TdcCollection;b.each(a,function(a,c,b){tdcIFrameData._getData(e,a,k)});b.isEmpty(k)||(tdcDebug.log(k),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",!0,!1));a={error:e,shortcode:e};tdcIFrameData.checkCurrentData(a);b.isUndefined(a.error)||(tdcDebug.log(a.error),new tdcNotice.notice(k,!0,!1));if(h.length!==tdcIFrameData.tdcRows.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",
...
k[a.param_name],l=c.newImages.find(function(a){return f===a.uid.substring(8)});"undefined"!==typeof l&&(m[e]=l.attachment_id)}else if("tdc_css"===a.param_name&&""!==k.tdc_css){var h=JSON.parse(window.atob(k.tdc_css));b.map(h,function(a,e){b.map(h[e],function(a,b){var d=c.newImages.find(function(c){return a===c.uid.substring(8)});"undefined"!==typeof d&&(h[e][b]='url("'+d.url+'")')})});m.tdc_css=window.btoa(JSON.stringify(h))}})}),k=m,a.set("attrs",k));if("td_block_text_with_title"===q||"vc_column_text"===
q||"vc_raw_html"===q)if(b.map(k,function(a,c){"content"!==c&&(h+=" "+c+'="'+a+'"')}),b.has(k,"content"))if("vc_raw_html"===q)h="["+q+h+"]"+b.unescape(k.content)+"[/"+q+"]";else try{var g=tdcUtil.b64DecodeUnicode(k.content);h="["+q+h+"]"+g+"[/"+q+"]"}catch(p){h="["+q+h+"]"+b.unescape(k.content)+"[/"+q+"]"}else h="["+q+h+"]";else switch(b.map(k,function(a,c){h+=" "+c+'="'+a+'"'}),d){case "single":h="["+q+h+"]";break;case "closed":g="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+
1)])||(g=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=e);h="["+q+h+"]"+g+"[/"+q+"]";break;case "template":h=c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=h;0===c.deepLevel&&(c.getShortcode+=h)}}else c.error="Not rows as the first elements!"}},checkCurrentData:function(a){tdcIFrameData._isInitialized&&b.each(tdcIFrameData.tdcRows.models,function(c,b,e){tdcIFrameData._checkModelData(tdcIFrameData.tdcRows.get(c.cid),a)})},changeData:function(a){if(tdcIFrameData._isInitialized){tdcMain.setContentModified();
var c=tdcOperationUI.getDraggedElement(),d=c.prevAll().length;if(a.wasSidebarElementDragged)if(a.wasElementDragged){var f=tdcIFrameData._getDestinationModel([".tdc-inner-column",".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);var q=tdcIFrameData._getDestinationCol();f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection);var k=f.get("childCollection");var h={},m=c.data("start-values"),g;"undefined"!==
typeof m&&(m=JSON.parse(window.atob(m)),"undefined"!==typeof m&&(b.isArray(m)&&m.length?(h=m[0],1<m.length&&(g=m)):h=m));m=c.data("shortcodeName");m=new tdcIFrameData.TdcModel({content:"",attrs:h,tag:m,type:"single",level:4,parentModel:f});new tdcIFrameData.TdcLiveView({model:m,el:c[0]});b.isUndefined(g)||m.set("presetValues",g);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(m.get("tag")+" : sidebar element added");c.data("model_id",m.cid);k.add(m,{at:d});m.set("parentModel",f);m.getShortcodeRender(q,
a.draggedBlockUid,!0)}else a.wasTempInnerRowDragged?(tdcRecycle.takeSnapshot("Sidebar inner-row added"),f=tdcIFrameData._getDestinationModel([".tdc-column"]),b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1),q=tdcIFrameData._getDestinationCol(),f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection),k=f.get("childCollection"),m=c.data("templateContent"),b.isUndefined(m)?(m=new tdcIFrameData.TdcModel({content:"",attrs:{},
tag:"vc_row_inner",type:"closed",level:2,parentModel:f}),new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:m}),c.data("model_id",m.cid),k.add(m,{at:d}),c=new tdcIFrameData.TdcCollection,c.add(h),m.set("childCollection",c),c=new tdcIFrameData.TdcCollection,h.set("childCollection",c)):(m=new tdcIFrameData.TdcModel({templateContent:m,attrs:{},tag:"vc_row_inner",type:"template",level:2,parentModel:f}),
new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),c.data("model_id",m.cid),k.add(m,{at:d})),m.getShortcodeRender(q,a.draggedBlockUid,!0)):a.wasTempRowDragged&&(tdcRecycle.takeSnapshot("Sidebar row added"),m=c.data("templateContent"),b.isUndefined(m)?(k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:k}),
c.data("model_id",k.cid),tdcIFrameData.tdcRows.add(k,{at:d}),d=new tdcIFrameData.TdcCollection,d.add(q),k.set("childCollection",d),d=new tdcIFrameData.TdcCollection,q.set("childCollection",d),a.wasElementWithRowDragged&&(h={},f={},m=c.data("start-values"),g=c.data("row-start-values"),"undefined"!==typeof g&&(f=JSON.parse(window.atob(g))),k.set({attrs:f}),"undefined"!==typeof m&&(h=JSON.parse(window.atob(m)),b.isArray(h)&&(h=h[0])),m=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",
attrs:h,tag:m,type:"single",level:2,parentModel:q}),d.add(c),d=new tdcIFrameData.TdcCollection,c.set("childCollection",d))):(k=new tdcIFrameData.TdcModel({templateContent:m,attrs:{},tag:"vc_row",type:"template",level:0,parentModel:e}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),c.data("model_id",k.cid),tdcIFrameData.tdcRows.add(k,{at:d}),d=new tdcIFrameData.TdcCollection,k.set("childCollection",d)),k.getShortcodeRender(1,a.draggedBlockUid,!0));else{m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model id is not in $draggedElement data!",
...
".tdc-column"]);b.isUndefined(f)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);g.cid===f.cid?(k=g.get("childCollection"),k.remove(m,{silent:!0}),k.add(m,{at:d})):(q=tdcIFrameData._getDestinationCol(),f.has("childCollection")||f.set("childCollection",new tdcIFrameData.TdcCollection),k=f.get("childCollection"),tdcIFrameData.removeModel(m,!1,{silent:!0}),k.add(m,{at:d}),m.set("parentModel",f),a.sourceColParam!==q&&m.getShortcodeRender(q,a.draggedBlockUid,!0));
...
q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:k}),tdcIFrameData.tdcRows.add(k,{at:0}),d=new tdcIFrameData.TdcCollection,d.add(q),k.set("childCollection",d),d=new tdcIFrameData.TdcCollection,q.set("childCollection",d),k.getShortcodeRender(1,a.draggedBlockUid,!0));return}tdcIFrameData.tdcRows.remove(m,{silent:!0});tdcIFrameData.tdcRows.add(m,{at:d});tdcRecycle.takeSnapshot("Row moved");tdcDebug.log("newPosition: "+d);tdcDebug.log(c)}}tdcDebug.log(tdcIFrameData.tdcRows)}},
...
""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",l="",f=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&f.length<=parseInt(d.tdc_min_options))return c;for(var g=0;g<f.length;g++){var k=!1,h="",m=f[g],n=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),p=String(d.value[f[g]]);_.isObject(d.value[f[g]])&&(k=!0,p=_.values(d.value[f[g]])[0],m=_.keys(d.value[f[g]])[0]);if(e||a){0===g&&""===n&&(n=p);n===p&&(h=" checked ");n=_.uniqueId();
var t=p;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)t="col_"+t;l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+n+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+h+' value="'+p+'">';e?(h="",k&&(h="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+h+'" for="'+n+'" title="'+m+'"><div class="'+t+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+n+'" title="'+m+'">'+
p+"</label>"}else n===p&&(h=' selected="selected" '),l+="<option "+h+' value="'+p+'">'+m+"</option>"}f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+f+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=l:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+l+"</select>");return c+
...
(k=h[tdcSidebar.currentViewportSettings.name])}catch(r){}for(h=0;h<f.length;h++){var m=!1,n="",p=f[h],t=String(d.value[f[h]]);_.isObject(d.value[f[h]])&&(m=!0,t=_.values(d.value[f[h]])[0],p=_.keys(d.value[f[h]])[0]);if(e||a){0===h&&""===k&&(k=t);k===t&&(n=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+
'" '+n+' value="'+t+'">';e?(n="",m&&(n="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+n+'" for="'+v+'" title="'+p+'"><div class="'+u+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+p+'">'+t+"</label>"}else k===t&&(n=' selected="selected" '),l+="<option "+n+' value="'+t+'">'+p+"</option>"}f="";_.has(d,"description")&&""!==d.description&&(f=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+
